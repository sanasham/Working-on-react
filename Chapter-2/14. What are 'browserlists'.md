...
Browserslist queries are based on the data from the Can I Use website, which provides up-to-date information on the support for various browser features. By using Browserslist, you can ensure that your project is compatible with the latest versions of browsers, while still being able to support older browsers if necessary, like say for a government web-app.
...
**https://browserslist.dev/**    you can check here